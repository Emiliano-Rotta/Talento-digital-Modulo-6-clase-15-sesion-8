...
//   return a * b;
// };
// console.log(multiplicar(2, 3)); // Debería devolver un error
...
// const sumaArray = (arr)  => {
//     let suma = 1 //aqui está el error
//     arr.forEach((num) => {
//         suma += num
//     });
//     return suma
// }
// console.log(sumaArray([2,8]))
...
//     }
//   };
//   console.log(convertirNumero("ABC")); // Resultado: "El valor ingresado no es un número válido"
